...
# su-exec to requested user, if service cannot run exec will fail. for alpine without shadow and util-linux, but with su-exec (su-exec>=0.2).
#docker_switch_user_alpine() {
